...
****************************************
*/
float ptz_horiz_get_realtime_degree(void)
{
...
****************************************
*/
uint16_t ptz_horiz_get_speed_set_val(void)
{
...
void ptz_horiz_motion_ctrl_thread(void const * argument)
{
  ...
  while(1)
  {
    ...
    extern UNS16 control_word_6040 ;	
...
int ptz_horiz_motion_ctrl_init(void)
{
  ...
  can_open_NodeID_CO_Data_register(od, 1);
